# =============================================================================
# Fits and validates the marginal EGPD mixture model for FWI using Stan CSV
# output. Computes and plots the marginal CDF, the probability integral
# transform to uniform, and QQ plots to assess model fit.
#
# Inputs:    samplers/stan/marg_transform/csv_fits/  (Stan output)
#            data/raw/erc_fwi_{station}.json
# Outputs:   figures/marg_transform.pdf, figures/qq_plot_marg_transform*.pdf
# =============================================================================
...
# Mixture density: EGPD in the tail with an untruncated exponential bulk.
...
# CDF of the EGPD / exponential mixture.
...
qs::qsave(fire_data_list, file = "data/raw/fire_data_expo.qs")
