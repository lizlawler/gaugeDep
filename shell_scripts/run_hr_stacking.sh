...
parentjob=$(sbatch --parsable $1 --job-name ${gauge_name}_${likelihood}_${threshold}_${dep_type}_${level}_hr_sampling \
...
--job-name ${gauge_name}_${likelihood}_${threshold}_${dep_type}_${level}_hr_params \
--output="./shell_scripts/console_output/stacking/%x_%j.txt" \
