# =============================================================================
# viz_exceed_quant_reg.R
#
# Validates and visualises the quantile regression threshold estimate by
# comparing the theoretical exceedance probability P(R > r0(W) | W=w) to
# the empirical exceedance rate. Used to justify the 95th quantile threshold.
#
# Inputs:    (generates data internally using theoretical distributions)
# Outputs:   figures/quantile_threshold.png
# =============================================================================

# Comparison of theoretical P(R>r_0(w)|W=w) from integrating f_R|W(r|w) 
# to P(R>r_0(w)|W=w) based on a Gamma(2,g(w)) distribution
# logistic functions courtesy of Jenny Wadsworth
...
# function to grab top n points via marginal threshold
...
# function to plot both exceedance probabilities separately
...
#function to plot true/gamma probabilities (ratio)
