...
# viz_copulas.R
#
# Produces scatter plots illustrating the three bivariate dependence structures
# used in the simulation study (Gaussian, logistic / Gumbel, Husler-Reiss)
# at varying dependence levels, in both Euclidean and polar coordinates.
#
# Inputs:    (generates data internally from theoretical distributions)
# Outputs:   figures/copulas/gauss_cops_plots.png
#            figures/copulas/logistic_cops_plots.png
#            figures/copulas/invlog_cops_plots.png
# =============================================================================
