# =============================================================================
# stacking_wts_boxplots.R
#
# Produces boxplots of BMA model weights (stacking, pseudo-BMA, pseudo-BMA+)
# across all 200 simulation study datasets, one plot per dep_type/likelihood/
# dep_level combination. Reads the pre-extracted weight .qs files from
# fits_and_weights/wts_joint_model/.
#
# Inputs:    fits_and_weights/wts_joint_model/{dep_type}_{likelihood}_{ang_dens}_{dep_level}.qs
# Outputs:   figures/boxplots_stacking_wts/{gauge}_{likelihood}_{dep_level}_boxplot.pdf
# =============================================================================
