# =============================================================================
# Computes BMA-weighted importance-sampling exceedance probability predictions
# on the real fire weather data (ERC x FWI) for a specified station and
# prediction task (return-level box). Uses posterior-median parameters from
# all MCMC fits for a single iteration of predictions.
#
...
# Outputs:   data_analyses/pred_boxes.qs  (prediction tibble)
# =============================================================================
